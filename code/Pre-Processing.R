...
data_folder = "data/DCLP3 Public Dataset - Release 3 - 2022-08-04"
...
roster = as.data.frame(
  read.table(paste0("data/DCLP3 Public Dataset - Release 3 - 2022-08-04/Data Files/PtRoster_a.txt"),
             sep = "|", header = TRUE, fileEncoding = "UTF-16LE", stringsAsFactors = FALSE, na.strings = "") %>% rename(id = PtID)
)

visit = as.data.frame(
  read.table(paste0("data/DCLP3 Public Dataset - Release 3 - 2022-08-04/Data Files/VisitInfo_a.txt"),
             sep = "|", header = TRUE, fileEncoding = "UTF-16LE", stringsAsFactors = FALSE, na.strings = "") %>% rename(id = PtID)
)
...
write_csv(phase_trial, "data/cleaned_data.csv")
